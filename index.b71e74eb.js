...
/* scroll */ const navEl = document.querySelector("nav");
...
const elementToNavAnchor = new Map(anchoredElements.map((element, index)=>[
        element,
        anchors[index]
    ]));
...
/* navigation */ const navButton = document.querySelector(".menu-toggle");
...
/* accordion */ const getActualHeight = (element)=>{
...
/* dialog */ const dialog = document.querySelector("dialog.reference_dialog");
